...
$codeValue = $program['code'];
$titleValue = $program['title'];
$yearsValue = $program['years'];
...
elseif ($programModel->codeExists($codeValue,$id)) {
...
if ($programModel->update($id,$codeValue,$titleValue,$yearsInt,$updatedBy)) {
